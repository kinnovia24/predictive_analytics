...
if a1 == 'Home':
#    st.markdown(f"<h1 style='background-color: ;color: black '>KINNOVIA Automotive Analytics Platform </h1>", unsafe_allow_html=True)
    #st.image("pexels-pixabay-164634.jpg", width=400)
    st.markdown(f"<h1 style='background-color: ;color: black '>KINNOVIA automotive Analytics Platform"
            "\n\n\n where we scrap the Industry by all companies and activities involved in the manufacture of motor vehicles,"
            ...
            "\n\n Lets analyze the automotive industry and grow.</h1>", unsafe_allow_html=True)
...
if a1 == 'Explore':
    ...
    st.sidebar.title("Lets do some Analysis!" )
#    st.sidebar.image("download.png", width=100)
    ...
    if b1 == 'Visual Representation':
        st.markdown(f"<h1 style='background-color: ; color: black'> Visual Representation & Analysis </h1>", unsafe_allow_html=True)
     ...
     #----2 feature - Dependency and Analysis------
        ...
        st.markdown(f"<h1 style='background-color: ;color: black'> Dependency & Analysis </h1>",
                    unsafe_allow_html=True)
    ...
    #---- 3 feature- Price Prediction------
        ...
        st.markdown(f"<h1 style='background-color: ;color: black'> Price Prediction </h1>",
                    unsafe_allow_html=True)
    ...
    #----4 feature - Automobile News------
        ...
        st.markdown(f"<h1 style='background-color: ; color: black'> Automobile News </h1>",
                    unsafe_allow_html=True)
    ...
    #----5 feature - Resolve Queries------
        ...
        st.markdown(f"<h1 style='background-color: ;color: black'> Resolve Queries</h1>",
                    unsafe_allow_html=True)
    ...
    #----6 feature - Web Scraping------
        ...
        get_web()
        st.markdown(f"<h1 style='background-color: ;color: black'> Web Scraping </h1>",
                    unsafe_allow_html=True)
...
if a1 == 'About':
    st.markdown(f"<h1 style='background-color: ;color: black'> ABOUT </h1>", unsafe_allow_html=True)
    st.markdown(f"<h3 style='background-color: ;color: black'> Data Analysis : </h3>", unsafe_allow_html=True)
    st.write(
        "Data Analysis is the process of systematically applying statistical and/or logical techniques to describe and illustrate, condense and recap, and evaluate data.")
    st.markdown(f"<h3 style='background-color: ;color: black'> Visual Representation : </h3>", unsafe_allow_html=True)
    st.write(
    ...
    st.markdown(f"<h3 style='background-color: ;color: black'> Dependency & Analysis : </h3>", unsafe_allow_html=True)
    st.write(
    ...
    st.markdown(f"<h3 style='background-color: ;color: black'> Price Prediction : </h3>", unsafe_allow_html=True)
    st.write(
        "You can predict the price of a car by inputting several parameters such as width, horsepower, engine size etc.")
    st.markdown(f"<h3 style='background-color: ; color: black'> Resolve Queries : </h3>", unsafe_allow_html=True)
    st.write(
    ...
    st.markdown(f"<h3 style='background-color: ;color: black'> Automobile News : </h3>", unsafe_allow_html=True)
    st.write(
    ...
    st.markdown(f"<h3 style='background-color: ;color: black'> Web Scraping : </h3>", unsafe_allow_html=True)
    st.write(
